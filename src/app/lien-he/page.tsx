...
const Contact = () => {
  ...
  return (
    <div className="w-screen min-h-screen bg-gray-100">
      {/* Bản đồ */}
      <div id="map-section" className="w-screen h-[450px] md:h-[600px] relative">
        <iframe
      ...
      <div className="container mx-auto px-4 py-8 md:px-8">
        <div className="grid grid-cols-12 gap-8">
          {/* Thông tin liên hệ */}
          <div className="col-span-12 md:col-span-3 bg-white p-6 rounded-lg shadow-lg">
            <h2 className="text-2xl font-bold mb-4 text-gray-700">Thông tin liên hệ</h2>
          ...
          <div className="col-span-12 md:col-span-7">
            <div className="bg-white p-6 rounded-lg shadow-lg">
              <h2 className="text-2xl font-bold mb-4 text-gray-700">Form liên hệ</h2>
